...
这里是关于数值计算与计算机应用 2023 [求解大规模稀疏垂直线性互补问题的二步模基并行算法](https://computmath.cjoe.ac.cn/szjs/CN/10.12288/szjs.s2022-0868#4)的代码。这里是openmp的版本 还有一份openacc的版本详情请参考[`openacc`](./openacc)
