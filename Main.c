    ...
    for (iters = 0; iters < maxit; iters++)
    {
        ...
        for (i = 0; i < numworkers; i++)
        {
            ...
            if (runAlgorithmTag > 0)
            {
                ...
                int threadCursor_1 = i * maxRowLen;
                int threadCursor_2 = i * (maxRowLen + 1);
                int threadCursor_3 = i * maxRowLen * 5;
        ...
        if (runAlgorithmTag > 0)
        {
            ...
            for (i = 0; i < numworkers; i++ )
            {
                ...
                int cursor_1 = z_cursor1[i], cursor_2 = z_cursor2[i];
                double zminval = 0, ztmpval = 0;
                int j,k;
                z_sum[i] = 0;
...
{
    //查验是否支持openmp的代码
    if(_OPENMP) printf("in_the_tank\n");
    else printf("out_the_tank\n");
